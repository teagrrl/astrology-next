	...
	return (
		<section className="flex flex-col grow justify-center text-center">
			...
			<h2 className="text-2xl p-4 font-semibold">
				...
				<Link href="/legacy/teams"><a className="p-0.5 hover:px-2 rounded-md transition-all hover:text-white hover:bg-black dark:hover:text-black dark:hover:bg-white">Choose a team to begin.</a></Link>
			</h2>
