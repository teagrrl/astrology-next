...
export type ChroniclerKind = "player" | "team"
...
async function teamsFetcher() {
    return await pagedFetcher<ChroniclerWrapper<BlaseballTeam>>("entities", "team")
}

async function playersFetcher() {
    return await pagedFetcher<ChroniclerWrapper<BlaseballPlayer>>("entities", "player")
}
